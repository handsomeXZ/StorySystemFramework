...
#define LOCTEXT_NAMESPACE "SDTGraphEdSchemaActions"

//////////////////////////////////////////////////////////////////////////
// FSDTSchemaAction_AddComment
UEdGraphNode* FSDTSchemaAction_AddComment::PerformAction(class UEdGraph* ParentGraph, UEdGraphPin* FromPin, const FVector2D Location, bool bSelectNewNode)
{
...
UEdGraphNode* FSDTSchemaAction_NewNode::PerformAction(class UEdGraph* ParentGraph, UEdGraphPin* FromPin, const FVector2D Location, bool bSelectNewNode)
{
...
UEdGraphNode* FSDTSchemaAction_NewNode::PerformAction(class UEdGraph* ParentGraph, TArray<UEdGraphPin*>& FromPins, const FVector2D Location, bool bSelectNewNode)
{
	UEdGraphNode* ResultNode = nullptr;
	if (FromPins.Num() > 0)
	{
...
void FSDTSchemaAction_NewNode::AddReferencedObjects(FReferenceCollector& Collector)
{
