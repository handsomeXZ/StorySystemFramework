...
/////////////////////////////////////////////////////
// SGraphNode_SDTSelector
void SGraphNode_SDTSelector::Construct(const FArguments& InArgs, USDTGraphNode* InNode)
{
...
void SGraphNode_SDTSelector::GetNodeInfoPopups(FNodeInfoContext* Context, TArray<FGraphInformationPopupInfo>& Popups) const
{

}

void SGraphNode_SDTSelector::UpdateGraphNode()
{
	InputPins.Empty();
	OutputPins.Empty();
	...
	this->GetOrAddSlot( ENodeZone::Center )
		...
		[
			...
			.Padding(0.0f)
			.BorderBackgroundColor( this, &SGraphNode_SDTSelector::GetBorderBackgroundColor )
			[
				SNew(SOverlay)
								...
								SNew(SVerticalBox)
									...
									[
										...
										[
											...
											.UseLowDetailSlot(this, &SGraphNode_SDTSelector::UseLowDetailNodeTitles)
											.LowDetail()
											[
												SNew(SBox)
											...
											[
												...
												[
													...
													[
														...
														.OnVerifyTextChanged(this, &SGraphNode_SDTSelector::OnVerifyNameTextChanged)
														.OnTextCommitted(this, &SGraphNode_SDTSelector::OnNameTextCommited)
														.IsReadOnly( this, &SGraphNode_SDTSelector::IsNameReadOnly )
														.IsSelected(this, &SGraphNode_SDTSelector::IsSelectedExclusively)
													]
													+SVerticalBox::Slot()
													.AutoHeight()
													[
...
void SGraphNode_SDTSelector::CreatePinWidgets()
{
	...
	for (int32 PinIdx = 0; PinIdx < MyNode->Pins.Num(); PinIdx++)
	{
		...
		if (!MyPin->bHidden)
		{
			TSharedPtr<SGraphPin> NewPin = SNew(SSDTGraphPin, MyPin)
				.ToolTipText(this, &SGraphNode_SDTSelector::GetPinTooltip, MyPin);
...
FText SGraphNode_SDTSelector::GetPinTooltip(UEdGraphPin* GraphPinObj) const
{
...
void SGraphNode_SDTSelector::AddPin(const TSharedRef<SGraphPin>& PinToAdd)
{
...
FSlateColor SGraphNode_SDTSelector::GetBorderBackgroundColor() const
{
	...
	USDTGraphNode_DSelector* MyNode = CastChecked<USDTGraphNode_DSelector>(GraphNode);
